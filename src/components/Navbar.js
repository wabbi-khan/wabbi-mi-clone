    ...
    return (
        <div className="nav">
           <div className="logo">
               ...
               <a href="/redmiphone" className="navlinks">Redmi Phones</a>
               ...
               <a href="/fitness&lifestyle" className="navlinks">Fitness & Lifestyle</a>
               ...
               <div className="searchbox">
                   <input type="text" name="search" placeholder="Search Producct" />
                   {searchIcon}
               </div>
