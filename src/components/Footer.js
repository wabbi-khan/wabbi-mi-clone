...
const arrowIcone=<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6-6-6z"/></svg>
    ...
    return (
        <>
         <div className="preFooter">
             ...
             <div>
                 {mapIcon}
                 <p><b>Vast service network</b> <br/>1000 MI service-centers acroos 600 cities</p>
             </div>
         </div>
         ...
         <div className="footerBorder">
             <div>Copyright &copy; 2021 Wahab-Khan. All Rights Reserved</div>
         </div>
